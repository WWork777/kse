...
export default function ServicesSecond() {
  ...
  const services = [
    ...
    },
    {
      ...
      price: "2 тысячи рублей (лобовое)",
    },
    {
      title: "Ночная полировка",
      description:
        "Специальная полировка стекла, выполняемая в тёмное время суток с использованием ярких фонарей и ламп. Это позволяет мастеру видеть даже самые мелкие царапины, голограммы и разводы, которые незаметны днём. Результат — безупречно чистое и прозрачное стекло без малейших дефектов.",
      price: "от 7 тысяч рублей",
    },
  ];
